  ...
  <div className="min-h-screen bg-black text-white">
    ...
    <div className="relative z-10 w-full p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-green-400 mb-2">Miach</h1>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/4 space-y-6">
          {/* Rooms Section */}
          <Card className="p-4 bg-gray-900 border-gray-800p">
            <h2 className="text-xl font-semibold mb-4">Rooms</h2>
            <div className="space-y-2">
              <div className="p-2 hover:bg-gray-800 rounded cursor-pointer">KelasFullstack</div>
            </div>
          </Card>
        ...
        <div className="flex-1 space-y-6">
          ...
          <Card className="p-4">
            ...
            {/* Diskusi 1 */}
            <div className="mb-6 pb-6 border-b border-gray-700 last:border-0 last:pb-0 last:mb-0">
              <h3 className="text-lg font-medium mb-1">Alur UX dari kelas ke kelas</h3>
              <p className="text-gray-400 text-sm mb-2">
                Oleh Muhammad Aabid Asaduddin, 2 jam yang lalu, di room KelasFullstack
              </p>
              <p className="text-gray-300">
                Disanyakan di kelas Panduan Member KelasFullstack.id, Topik Laporan
              </p>
            </div>
            
            {/* Diskusi 2 */}
            <div className="mb-6 pb-6 border-b border-gray-700 last:border-0 last:pb-0 last:mb-0">
              <h3 className="text-lg font-medium mb-1">membuat job dan scheduler</h3>
              <p className="text-gray-400 text-sm mb-2">
                Oleh Marcellinus Arlo Xavier Saputra, 7 jam yang lalu
              </p>
              <p className="text-gray-300">
                Disanyakan di kelas Mengembangkan Sistem Streaming Seperti Netflix Menggunakan Laravel 11, 
                Topik Membuat Command Untuk Menjalankan Job Dan Scheduler
              </p>
            </div>
          </Card>
        </div>
